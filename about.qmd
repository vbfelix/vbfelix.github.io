...
Since 2013, I've been working with data analysis. During my studies in graduation, I focused on time-series, geostatistics, and data visualization.

In 2016, I co-founded a data consulting firm (H0) with a partner, and we worked on over 300 scientific studies and over 40 surveys for businesses. Our job entailed assisting to maximize the use of statistics, from sample design to analysis, and sometimes even training others to use the techniques themselves.
