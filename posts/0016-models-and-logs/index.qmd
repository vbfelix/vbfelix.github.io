...
#https://www.dummies.com/article/business-careers-money/business/economics/the-linear-log-model-in-econometrics-156470/
```

In this post, we will see how we can combine log with models to help our interpretation.
