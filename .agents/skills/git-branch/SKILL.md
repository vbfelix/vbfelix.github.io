...
4. Use a short lowercase kebab-case name. Prefer `<type>/<purpose>`, with `codex/` as the project default prefix when no convention or explicit name overrides it. Useful types include `feat`, `fix`, `docs`, `refactor`, `test`, and `chore`.
