...
Datlo has a location intelligence platform for go-to-market and expansion teams. As Head of Data for a data-driven product, my responsibilities included technology integration, advanced analytics, data governance, obtaining a variety of datasets, cross-functional collaboration, customer consultation, regulatory compliance, and ongoing platform improvement.

To do this, I implemented a data architecture that could enable automation extraction, tests, and a standard set of tools and procedures for 100+ data sources.
