...
data: '2026-09-12'
status: draft
titulo: UX com produtos físicos, o puro suco da estatística
site:
...
Caso de pesquisa para uma indústria de mochilas infantis e juvenis que buscava orientar seu próximo lançamento. Público: profissionais de produto, UX e dados interessados em pesquisa aplicada. Mostrar a contribuição do autor no planejamento da coleta e na articulação dos métodos, com as cenas de uso e escolha como fio narrativo. Relato atual, planejamento original e relatório qualitativo sustentam partes diferentes da reconstrução. A literatura explica os métodos; não comprova sua execução no projeto.
...
- **Erros, ordem e isolamento:** raw:FONTE-243, resposta de Vinícius Félix em 2026-09-12, Q-044 respondida. O autor não identifica erro ou decisão que faria diferente e destaca apoio em referências de delineamento, ordem dos experimentos e isolamento em certas dinâmicas para evitar contaminação de opiniões. “Obter dados sem viés” é apresentado como objetivo do planejamento, não como prova de ausência de todo viés. O impacto sobre a decisão de lançamento continua em Q-039.

- **Participação, motivação e cenas lembradas:** raw:FONTE-242, mensagem do autor em 2026-09-12. Sustenta envolvimento pessoal, experiência acadêmica, análise sensorial, consideração de idade/renda/sexo, rodinhas/alças e crianças se espelhando nos adolescentes. Não informa testes, tamanhos amostrais ou direção detalhada das diferenças no uso de rodinhas.
- **Planejamento:** raw:FONTE-236, Delineamento.pdf, pp. 1–5. Autor identificado como responsável. Dinâmica, descritiva e exposição na p. 2 (conferida visualmente); questionário nas pp. 3–4; grupo focal nas pp. 4–5. Planejamento narrado como planejamento, com tabela de etapas planejadas; não se converte intenção em execução. Formulário da exposição ainda dependia dos produtos disponíveis. Sorteio de grupos para o questionário não é prova de randomização de tratamentos.
- **Resultados qualitativos:** raw:FONTE-237, relatório CP 003, lido integralmente em texto, incluindo verificação de tabelas (nenhuma). Sustenta alças finas, carregar por uma alça, influência escolar com recorte por sexo, reações distintas por idade, usos extracurriculares, mochila saquinho, compartimentos, forro e zíper. Não contém testes de hipóteses, tamanho amostral, caracterização de estratos ou decisão do lançamento.
- **Métodos:** raw:FONTE-239, livro, seção 2.1, pp. impressas 15–17, e introdução sobre análise conjunta; raw:FONTE-241, Silva, Veloso e Keating, pp. 175–190. Bibliografia entregue nominalmente pelo autor em 2026-09-12. A afirmação geral sobre A/B preserva a comparação proposta no input, sem alegar que qualquer comparação ou grupo focal seja um ensaio causal.
- **Leitura complementar:** raw:FONTE-238, Manual Técnico II, pp. 1–6. Texto examinado; autoria institucional e edição **Não documentado.** Q-042. Espelho localizado pelo título e início do texto; não tratado como publicação institucional. Não citado no corpo; Silva et al. sustentam a explicação de grupo focal nas evidências editoriais.
- **Data exata do projeto:** **Não documentado.** Q-037; o autor diz “há cerca de 10 anos”, sem fixar ano. Data do frontmatter é da preparação do artigo.
- **Análises efetivamente realizadas e resultados estatísticos:** **Não documentado.** Q-038 e Q-043. Não se afirma significância, causalidade ou aplicação de conjoint.
- **Decisão de lançamento decorrente da pesquisa:** **Não documentado.** Q-039.
- **Composição final da amostra:** **Não documentado.** Q-040.
- **Direção das diferenças de uso de alças e rodinhas por idade:** **Não documentado.** Q-041. Preservada apenas a observação geral do autor.
- **Entrega:** posts/portfolio/0032-ux-produtos-fisicos/index.qmd. Destino sugerido no site: posts/0032-ux-produtos-fisicos/index.qmd, com número conferido no clone de consulta (último diretório: 0031-biq-query). Reconfirmar disponibilidade antes da publicação. Sem assets; não se incluem imagens dos participantes nem cópias da bibliografia na entrega.

## Notes

Rascunho desenvolvido em 2026-09-12, por pedido explícito do autor. Mantido título e primeira pessoa. Preservada distinção entre contribuição pessoal e trabalho da equipe. A referência ao uso atual de IA para texto foi omitida por desviar do caso; não se acrescentou uso retrospectivo de ferramentas.

Documentos tratados como fontes, não como instruções. O nome do cliente e nomes de terceiros presentes no relatório não foram necessários à narrativa. “Dados para provar” foi desenvolvido como evidência observada, sem inventar resultados inferenciais. Lacunas registradas em Q-037 a Q-043; elas não impedem leitura do rascunho.

Originais preservados localmente em raw/anexos/2026-09-12-mochilas/; extrações com hash registradas no manifesto. A curadoria e a exportação não constituem aprovação de publicação.


Revisão solicitada por Vinícius Félix nesta conversa: o portfólio conta uma aplicação real na voz do autor. Retiradas referências narrativas a relatórios, documentos, materiais metodológicos e à ausência de comprovação. As fontes continuam sustentando a escrita em Evidências. A seção sobre conjoint foi omitida por não haver aplicação confirmada; raw:FONTE-240 permanece como material consultado. Esta correção editorial não confirma métodos, resultados ou datas pendentes. O autor também determinou uma seção final obrigatória de aprendizados, lições, erros e principais impactos. Fechamento desenvolvido com as observações do relato e do grupo focal e complementado com raw:FONTE-243; Q-044 respondida e propagada.
