...
My graduate studies focused on time-series, geostatistics, and data visualization. I received a scholarship for the Brazilian Program of Scientific Initiation (PBIC), which required students to conduct a research and present them in a congress after one year, and I completed two of them:

1.  \[2014\] Topics on wavelet variance;

2.  \[2015\] Wavelet multiple cross-correlation.

Besides that I was also a member of the study group of spatial and temporal statistics, having worked with techniques to apply in time series and also with geostatistics, I decided to do a final paper about clustering methods for temporal, spatio, and spatio-temporal data.
...
I decided to pursue a master's degree in Biostatistics after graduating in the beginning of 2017. My dissertation was about spatio-temporal geostatistics models, that was a natural choice since and had developed project on temporal and spatial statistics during graduation, so I decided to work with both of them.

Also I assisted one of my advisors in the development of the [geotoolsR](https://github.com/cran/geotoolsR) R package, providing code to apply bootstrap in the context of geostatistics.

Lastly, I also chose epidemiology and psychometrics as my optional credits.
...
I updated the course topics by changing the material to a more modern and applied concept of statistics; despite the fact that it was only an introduction, I used my hands-on experience to demonstrate real-world application of theoretical concepts.
...
Later, in the end of the year, I was given a promotion to lead the whole R&D in 2021, and as such, I was in charge of the software development team in addition to the data, having the responsability of the:

-   Implementation of automation projects using robots (Jira Automation), web scraping (Python/R), and Metabase to improve data monitoring and data-driven decision-making;

-   Applying agile methodologies and software development concepts in the execution of R&D projects to drive continuous process improvement;
...
-   Building project teams, developed project schedules, and set project goals to meet overall project needs.

### [2022-2023] Strategy Manager

In order to offer better actions through data science, GA merged with Intergado in 2022, a company that makes hardware for accurately automating data collection. As the company's new strategy manager, my current responsibilities include:
