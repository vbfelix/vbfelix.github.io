...
data: '2026-09-12'
status: draft
titulo: Quando provas precisam de provas
site:
...
Relato do apoio do autor à avaliação de avaliações médicas, ligado à sua formação em Psicometria. Explicar variáveis latentes, TRI e equações estruturais, mantendo os dois últimos como complemento conceitual, conforme confirmação explícita. A aplicação documentada envolve análise clássica de itens e confiabilidade, além do contexto de avaliação prática. Não atribuir autoria exclusiva de relatórios ou trabalho no Enem.
...
- raw:FONTE-257: título, apoio à avaliação de avaliações, Psicometria como matéria favorita no mestrado e expressão “medir o não mensurável”. Confirmação de que SEM significa modelos de equações estruturais e de que TRI e SEM entram como explicação conceitual.
- raw:FONTE-258: relatório Hemato_2019_v4.docx, análise de escores, dificuldade, discriminação, alternativas e confiabilidade. Sustenta sinais qualitativos descritos no artigo. Não foram recalculados resultados. Há divergências internas em números e listas de itens; por isso não se reproduzem contagens, coeficientes, porcentagens ou identificação de itens específicos.
- raw:FONTE-259: relato de experiência v5. Sustenta contexto de provas médicas, matriz de avaliação, revisão por pares, relatórios estatísticos e estudo da consistência entre examinadores. Não atribui ao autor condução dos treinamentos ou autoria exclusiva.
- referencia/inep-tri-no-enem: complemento conceitual pesquisado sobre TRI e uso no Enem. Consulta limitada aos trechos indexados dos documentos oficiais; tentativas de leitura integral do PDF falharam. Q-059 registra confirmação nominal.
- referencia/projeto-lavaan-modelos-de-equacoes-estruturais: páginas oficiais sobre SEM e análise fatorial confirmatória consultadas integralmente. Q-060 registra confirmação nominal. Não comprova uso de lavaan nos projetos.
- **Não documentado.** Mudanças efetivamente realizadas nas provas a partir das análises e seus efeitos, Q-061 e Q-062. O fechamento não atribui melhoria mensurada à intervenção.
- Originais DOCX e extrações textuais preservados em `raw/inputs/2026-09-12_avaliacoes/`, hashes nas fontes. Consulta focada no relato v5 da primeira pasta e relatório de hematologia v4 da segunda, sem auditoria integral das bases, imagens ou demais versões.
- Entrega: `posts/portfolio/0037-quando-provas-precisam-de-provas/index.qmd`; destino no site: `posts/0037-quando-provas-precisam-de-provas/index.qmd`. Numeração local anterior até 0036; clone de consulta do site até 0031. Sem capa ou assets.

## Notes

- Formação pessoal acrescentada conforme pedido de 2026-09-12 e propagada ao perfil.
- A terminologia foi esclarecida pelo autor, sem substituir silenciosamente “semi-estruturais”.
- TRI e SEM são explicação conceitual por decisão expressa. Não afirmar ajuste desses modelos no caso ou participação no Enem.
- Apoio do autor confirmado; relatórios creditam outros profissionais. Preservar participação colaborativa, sem assumir autoria exclusiva ou cargo formal.
- Fechamento com aprendizados e armadilhas em bullets, distinguindo apoio diagnóstico de impacto medido.
- Referências pesquisadas permanecem rascunho/baixa até confirmação nominal. Artigo em draft.
