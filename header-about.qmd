...
In my last year I decided to enter the Junior Enterprises Nucleus of the University, to help create a census.
...
Later, in the end of the year, I was given a promotion to lead the whole R&D division in 2021, and as such, I was also in charge of the software development team in addition to the data, having the responsability of:
...
In order to offer better actions through data science, GA merged with Intergado in 2022, a company that makes hardware for accurately automating data collection, such as individual animal weight. As the company's new strategy manager, my current responsibilities include:
